...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { abv: @beer.abv, name: @beer.name, price: @beer.price, style: @beer.style } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { abv: @beer.abv, name: @beer.name, price: @beer.price, style: @beer.style } }
